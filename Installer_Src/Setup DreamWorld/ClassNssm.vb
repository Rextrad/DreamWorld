Public Class ClassNssm
    ...
    Public Sub InstallService()
        ...
        If NssmCommand($"install DreamGrid {Settings.CurrentDirectory}\Start.exe server") Then
    ...
    Public Sub StartService()
        If NssmCommand("start DreamGrid") Then
            TextPrint(My.Resources.ServiceInstalled)
        Else
    ...
    Public Sub StopAndDeleteService()
        ...
        If NssmCommand("stop DreamGrid") Then
            If NssmCommand("remove Dreamgrid confirm") Then
